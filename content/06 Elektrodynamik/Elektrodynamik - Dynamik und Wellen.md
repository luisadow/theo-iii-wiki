---
description: "Maxwell-Gleichungen, Potentiale, Eichungen, retardierte Potentiale, EM-Wellen, Poynting-Theorem und Dipolstrahlung im Überblick."
...
- Dipolstrahlung (Dipolmoment $\mathbf{p}(t)$):
  $$
  \mathbf{E}_{\text{rad}}(r, t) \approx \frac{\mu_0}{4\pi} \frac{\hat{\mathbf{r}} \times \big(\hat{\mathbf{r}} \times \ddot{\mathbf{p}}(t_r)\big)}{r}, \qquad
