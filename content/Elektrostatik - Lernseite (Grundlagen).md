...
1. Gauß-Fläche: Zylinder Radius $r$, Länge $L$
1. Gaußsches Gesetz:
...
- Ressourcen: `V5` Maxwell-Spannungstensor · `V6` Randwertprobleme (siehe `90_Resources`)
...
- [[20_Exercises/HA1/HA1 - Loesung]] über Gauß-Flächen, Basis-Poisson/Laplace und Kondensator-Formeln.
- [[20_Exercises/HA8/HA8.md]] für Randwert-Mix (Dirichlet/Neumann) und Materialeinsatz; siehe auch [[Randwertprobleme (Elektrostatik)]].
- [[20_Exercises/HA9/Aufgabe27_Loesung]] (Helmholtz/Gauges) zur Verbindung Feld-/Potentialdarstellung.
