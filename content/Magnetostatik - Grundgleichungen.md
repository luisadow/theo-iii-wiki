...
# Magnetostatik – Grundgleichungen & Überblick

Die Magnetostatik beschreibt stationäre Ströme und die dadurch erzeugten magnetischen Felder. Diese Notiz ergänzt die elektrostatistischen Seiten ([[Elektrostatik]]) und bereitet die dynamischen Maxwell-Gleichungen vor.
...
- **Tafelbilder:** `V11–V13` (Magnetostatik, Stromverteilungen, Magnetfeld in Materie) im Ordner `90_Resources`.
...
- [ ] Beispiele zu Randbedingungen an Oberflächenströmen (Platten, Spalte) ergänzen.
- [ ] Induktivität von Solenoid/Toroid detailliert herleiten.
- [ ] Weitere Vektorpotential-Beispiele (Coulomb- vs. Lorenz-Eichung) dokumentieren.
- [ ] Verbindung zu zeitabhängigen Maxwell-Gleichungen vorbereiten.
