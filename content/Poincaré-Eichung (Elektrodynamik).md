...
# Poincaré-Eichung (radiale Eichung)

Eichbedingung: $\mathbf{r} \cdot \mathbf{A}_p(\mathbf{r}, t) = 0$ (äquivalent $\int_0^1 du\, \mathbf{A}_p(u\mathbf{r}, t)\cdot\mathbf{r}=0$). Nutze sie, um Potentiale direkt aus Feldern auszudrücken. Relevanz: ÜB9 Aufgabe 28.
...
_Kompakte Karte für die Poincaré-Eichung; ergänze eigene Rechenschritte aus ÜB9._
