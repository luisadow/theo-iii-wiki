...
# Vektoranalysis – Toolbox für Theo III
...
Siehe [[Helmholtz-Zerlegung (Vektorfelder)]] für volle Projektorformeln und ÜB9-Hinweise.
...
## 6. Verweise & Backlinks

- **Hauptnotizen:** [[Elektrostatik]], [[Elektrostatik - Lernseite (Grundlagen)]], [[Energie und Kapazität in der Elektrostatik]]  
- **Geplante Ergänzungen:** [[Randwertprobleme (Elektrostatik)]], [[Multipolentwicklung (Elektrostatik)]], [[Dielektrika (Elektrostatik)]]  
- **Lernorganisation:** [[Lernplan]] (Woche 1 Crashkurs Vektoranalysis, Woche 7 Anwendungen)

---

## 7. To-Dos

- [ ] Beispielrechnungen (Gradient/Divergenz) in Kugel- und Zylinderkoordinaten ergänzen.  
- [ ] Eigene Zusammenfassung der Beweisideen für Gauß- und Stokes-Satz verlinken.  
- [ ] Verbindung zu Übungsaufgaben in `20_Exercises` herstellen (z. B. Operatoridentitäten anwenden).  
- [ ] Abschnitt „Operatoren in allgemeinen orthogonalen Koordinaten“ anlegen (Lamé-Koeffizienten).

---

*Diese Toolbox soll dich beim schnellen Nachschlagen unterstützen. Ergänze Beispiele und eigene Skizzen, sobald sie in den Vorlesungsnotizen oder Übungsblättern auftauchen, damit die Links in [[Elektrostatik]] immer auf vollständige Inhalte zeigen.*
