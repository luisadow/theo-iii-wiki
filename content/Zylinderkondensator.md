...
# Zylinderkondensator (Koaxialkondensator)
...
- Dünnwandig $b\to a$: $C\approx 2\pi\varepsilon L/(b-a)$ (linearisierter Logarithmus).
...
## Aufgaben-Anker
- Klausur-Stil: siehe [[90_Resources/Tagesplan - Tag 6#Block C — Anwendungsaufgabe (Klausur-Stil, 45–60 min)]].
- Übung: [[20_Exercises/HA1/HA1 - Loesung]] (Grundlagen), eigenes Drill-Szenario aus Block C.
